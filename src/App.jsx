...
function DuasView({ isDark }) {
    const duas = [
      ...
      { category: "أدعية الشفاء العام", items: [
          ...
          "اللهم إنا نسألك بأسمائك الحسنى وصفاتك العلا وبرحمتك التي وسعت كّل شيء، أن تمّن عليه بالشفاء العاجل، وأّلا تدع فينا جرحًا إّلا داويته، ولا ألمًا إلا سكنته، ولا مرضًا إلا شفيته."
      ]},
